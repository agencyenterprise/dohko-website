        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Cost-Effective ML Inference</h4>
              <p className="text-lg text-gray-400 text-center">Access advanced machine learning capabilities at a fraction of traditional costs. Dohko's network allows for efficient resource allocation and reduced overhead.</p>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Minimal Requirements</h4>
              <p className="text-lg text-gray-400 text-center">Prover nodes have low CPU and RAM requirements, enabling massive network scale. This allows anyone to participate, from individual device owners to large data centers.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Privacy-Preserving</h4>
              <p className="text-lg text-gray-400 text-center">Verify ML model results without exposing sensitive information. Dohko ensures data privacy throughout the entire computation process.</p>
            </div>
          </div>
